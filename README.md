...
如何将ChatGPT调教成一只猫娘以及关于ChatGPT的帮助，涩涩的教程在更多玩法中
# 🌟保存对话小工具🌟
- 在开始之前我强烈推荐你先准备好这个工具，它可以让你继续之前的对话（当然没有保存的不行）
...
- 注意！用这个绕过模板仍然有AI拒绝涩涩的可能，但是这个绕过模板很大概率上可以让AI涩涩，如果AI拒绝你了请直接New Chat再试，成功以后用上文的工具保存对话方便日后开箱即用
## 12/20更新:更稳定的涩涩
- 发送下文
...
- 如果ChatGPT拒绝了，请点你发的话右上侧的小按钮（方块+一支笔的样子），点Save&submit，多试几次，一般第二次就会说“我明白了”
- 发送涩涩的设定模板
