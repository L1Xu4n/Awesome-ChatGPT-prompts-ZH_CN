...
如何将你的 ChatGPT 调教成一只猫娘以及关于ChatGPT的帮助，涩涩的教程在更多玩法
...
查看 [额外设定](Customize_Settings.md) 页面，了解更多玩法
...
## 其他玩法有待开发中，如果你有好的想法可以提交 Issue 及 Pull request (可选)
 先在 Issue 中给出对话内容和演示后, 提交 pr(可选) 将 Issue 链接加入 [自定义设定Customize_Settings.md](Customize_Settings.md) 或 [扩展内容 Extensions.md](Extensions.md)页面中， 等待合并后即可成为贡献者，如果已过期请记得关闭(Close) Issue
